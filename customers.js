...
//////////////////////
// function fuckingfuckfuck(name, email, address, phonenumb, ssn) {
  // we need the name underlined
  // email
  // address
  // phone number
  // SSN
// for (let i = 0; i < customers.results.length; i++){
  //  console.log(customers.results[i].picture.medium)
  //  console.log(customers.results[i].name.first)
  //  console.log(customers.results[i].name.last)
  //  console.log(customers.results[i].email)
  //  console.log(customers.results[i].location.street)
  //  console.log(customers.results[i].location.city)
  //  console.log(customers.results[i].location.state)
  //  console.log(customers.results[i].location.postcode)
// }
// for (let i = 0; i < customers.results.length; i++){
//   function sosa(picm, fname, lname, email, street, city, state, zip, teleph, ssn){
//     let ssnstealer = `
//     <article>
//     <div class="pic">
//     <img src = ${picm} alt = "face">
//     </div>
//     <div class='info'>
//     <p>${fname} ${lname}</p>
//     <p>${email}</p>
...
//     </article>`
// }
//   var no = [customers.results[i].picture.medium, customers.results[i].name.first, customers.results[i].name.last, customers.results[i].email, customers.results[i].location.street, customers.results[i].location.city, customers.results[i].location.state, customers.results[i].location.postcode];
//
// document.querySelector('body').innerHTML = no;
// }
//   let personIdentity = `
// `
// }
//customers.results[0/1/2/3/4/5].name.first
